...
public class TestPorter {
    ...
    public void testStemFiles() throws IOException {
        BufferedReader inputReader = new BufferedReader(new FileReader("C:\\Users\\ASUS\\IR2\\library\\src\\input.txt"));
        BufferedReader expectedOutputReader = new BufferedReader(new FileReader("C:\\Users\\ASUS\\IR2\\library\\src\\output.txt"));
